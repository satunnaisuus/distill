...
export type RuntimeTokenListAccess = (currentToken: unknown) => unknown;
export type RuntimeTokenListContext = {
    readonly assertTokenIsInTokenList: RuntimeTokenListAccess;
    readonly registerToken: RuntimeTokenListAccess;
};

export type RuntimeFactory = (scope: RuntimeScope, dependencyTracker: RuntimeDependencyTracker | undefined) => unknown;
export type RuntimeDisposer = (value: unknown) => void | Promise<void>;
export type RuntimeBindingLifetime = "singleton" | "scoped" | "transient";
export type RuntimeRef<TValue> = {
...
export type RuntimePublicAccess = {
...
export type RuntimeBinding = {
    ...
    readonly lifetime: RuntimeBindingLifetime;
...
export type RuntimeContext = RuntimeTokenListContext & {
...
export type RuntimeRefInstance = {
    readonly ref: RuntimeRef<unknown>;
    readonly dependencyTrackers: Set<RuntimeDependencyTracker>;
};
